...
public class ScaleApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.ConfigureTestServices(services =>
        {
            ...
            var descriptor = services.SingleOrDefault(d =>
                d.ServiceType == typeof(DbContextOptions<ScaleDbContext>)
            );
    ...
    public async Task InitializeAsync()
    {
        ...
        var dbContext = scope.ServiceProvider.GetRequiredService<ScaleDbContext>();
